...
public class RawRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4736233026895972270L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RawRecord\",\"namespace\":\"manning.devices.raw.m1\",\"fields\":[{\"name\":\"uuid\",\"type\":\"string\"},{\"name\":\"arrival_time_ms\",\"type\":[\"null\",\"long\"]},{\"name\":\"body\",\"type\":[\"null\",\"bytes\"],\"default\":null},{\"name\":\"reference\",\"type\":[\"null\",\"string\"],\"default\":null}]}");
   ...
   */
  public RawRecord(java.lang.CharSequence uuid, java.lang.Long arrival_time_ms, java.nio.ByteBuffer body, java.lang.CharSequence reference) {
    this.uuid = uuid;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RawRecord>
    ...
    private Builder() {
      super(manning.devices.raw.m1.RawRecord.SCHEMA$);
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public manning.devices.raw.m1.RawRecord.Builder setReference(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public manning.devices.raw.m1.RawRecord.Builder clearReference() {
      reference = null;
